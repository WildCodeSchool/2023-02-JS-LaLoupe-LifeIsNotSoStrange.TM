      ...
      <div className="space-y-4">
        {options.map((option) => (
          <button
            type="button"
            key={option.id}
            className="bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50 text-white font-medium py-2 px-4 rounded-lg"
